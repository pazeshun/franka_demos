...
def main(argv):
    node = ImitationAgentServer(lstm_path='/home/ykawamura/integral_models/rlbench_pick_2_data_no_force/default_f_128x128_0epis/image_conv_vae_16dim_stride2_fc_bce_1.0kl/adam.001_itdecay1k/model_epoch0600_4.91e-01_4.90e-01/maxlen300_pred_shift3_emb-ja-go_emb-ja-go_noise-0.0-0.0_148epis/lstm_256units_split-mse_relu_n_lstm_layers_2_n_dense_layers_3_emb_loss_scale0.001/adam.001_itdecay1k_l2wreg1e-05/model_last_epoch1104.h5',
                                image_vae_path='/home/ykawamura/integral_models/rlbench_pick_2_data_no_force/default_f_128x128_0epis/image_conv_vae_16dim_stride2_fc_bce_1.0kl/adam.001_itdecay1k/model_epoch0600_4.91e-01_4.90e-01.h5',
                                action_dim=16)
    node.run()
